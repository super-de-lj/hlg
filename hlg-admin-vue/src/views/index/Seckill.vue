...
//获取秒杀数据
const getSeckill = async (flag:any)=>{
    loading.value = true
    var res = await service.pro.pro_showdata({type:'isseckill',flag});
    loading.value = false;
...
<template>
    <div class="seckill">
        ...
        <el-table :data="seckillList" v-loading="loading" style="width: 100%" class="table">
